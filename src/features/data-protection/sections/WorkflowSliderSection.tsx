...
const WORKFLOW_STEPS = [
  {
    ...
    imageSrc: "/images/data-protection/step-before.png",
  ...
  },
  {
    ...
    imageSrc: "/images/data-protection/step-client.png",
  ...
  },
  {
    ...
    imageSrc: "/images/data-protection/step-upload.png",
  ...
  },
  {
    ...
    imageSrc: "/images/data-protection/step-repository.png",
  ...
  },
  {
    ...
    step: 5,
    title: "The splits",
    imageSrc: "/images/data-protection/step-splits.png",
  ...
  },
  {
    ...
    imageSrc: "/images/data-protection/step-processing.png",
  ...
  },
  {
    ...
    imageSrc: "/images/data-protection/step-keys.png",
  ...
  },
  {
    ...
    imageSrc: "/images/data-protection/step-delivery.png",
  ...
  return (
    <article className="flex w-slide-card shrink-0 flex-col">
      <div className="relative">
        <div className="relative aspect-auto h-card-slide w-full overflow-hidden rounded-radius-lg border border-border sm:aspect-[4/3] sm:h-auto">
          <Image
            src={imageSrc}
            alt=""
            fill
...
const slides: SliderSlide[] = WORKFLOW_STEPS.map((item) => ({
  type: "custom",
  id: item.id,
  content: (
    <WorkflowStepCard
