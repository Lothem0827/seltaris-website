        ...
        <div className="flex flex-col gap-10">
          ...
          <div className="grid grid-cols-2 gap-12 lg:grid-cols-1">
            <Text className="px-8 sm:px-0">
              ...
              quietly ignore the remaining 15%. But when you&apos;re dealing
              with 100,000 addresses, that 15% isn&apos;t a small problem,
              it&apos;s 15,000 addresses that would otherwise need
              time-consuming manual effort to clean up and correct.
            </Text>
            <Text className="px-8 sm:px-0">
              ...
              quality of the addresses that fall outside standard validation. We
              clean them up, correct obvious issues, validate and repair what we
              can and standardise them to bring them in line with your verified
              data. The result? Even your unvalidated addresses are in the best
              possible shape.
            </Text>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-12">
          <div className="grid grid-cols-2 items-start gap-8 lg:grid-cols-1">
            ...
            <Text className="px-8 sm:px-0">
              ...
              suppliers in one system to give you the very best, utmost accurate
              results.
            </Text>
          </div>
          <FeatureImage
