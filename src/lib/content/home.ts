...
export const featureSliderSlides = [
  {
    ...
    title: "Easy to start.",
    description:
      "DataTools Seltaris makes it incredibly simple to import your data and uncover any deficiencies. With Advanced Health Check Reports, you'll quickly see exactly which aspects of your data need attention. And with built-in services to repair these issues in seconds, maintaining your data at its highest quality has never been simpler.",
    imageIndex: 0,
  },
  {
    id: "built-for-scale",
  ...
  },
  {
    ...
    description:
      "Built with the infrastructure and security credentials today's enterprise demands. DataTools Seltaris is designed to let organisations share data with absolute confidence. Security measures that ensure your data remains yours and is not accessible to anyone else (even DataTools).",
    imageIndex: 2,
  },
] as const;
